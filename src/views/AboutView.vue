...
<template>
  ...
  <main class="about-container faq-container" style="margin-top: 20px;">
    ...
    <div class="faq-item">
      ...
      Chris can also optimize your old and sluggish computers and devices to be able to perform like new or better than ever before.
      
      Complex tasks, complex operations, and whatever more will not be a roadblock for Chris.
      
      Chris is the most honest computer technician you will ever encounter. 
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      Let there be no confusion caused by time-consuming shopping!

      We will do the shopping while you enjoy the breeze.

      We are here to support your technological needs to keeps your workday smooth and making your personal time feel luxurious!
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer"> Unfortunately, Chris is disabled with severe anxiety (GAD) including social anxiety and ASD/ADHD, as well as Asthma and COPD.

      Chris has severely debilitating symptoms, including tics, both verbal and motor, but in no way does he
      intend to be unprofessional and/or offensive and apologizes if he makes you uncomfortable, disturbed, or
      offended.

      Chris feels remote assistance is not only the most convenient for the customer but is also an effortless way
      ...
      Chris also provides on-site <a href="services">services</a> to those in need.
